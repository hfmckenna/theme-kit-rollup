...
import ProductModel from '../snippets/productmodel'
import ProductVideo from '../snippets/productvideo'
...
const Product = (function () {
    function Product(container) {
        ...
        this._initModelViewerLibraries = function () {
            ...
            ProductModel.init(modelViewerElements, this.settings.sectionId);
        }
        ...
        this._setCartPopupImage = function (imageUrl, imageAlt) {
            ...
            var sizedImageUrl = getSizedImageUrl(imageUrl, '200x');
        ...
        this._showCartPopup = function () {
            Helpers.prepareTransition(this.cartPopupWrapper);
        ...
        this._switchMedia = function (mediaId) {
            var currentMedia = this.container.querySelector(
                this.selectors.productMediaWrapper +
                ':not(.' +
                this.classes.hidden +
        ...
        this._enableZoom = function (el, index) {
            this.zoomPictures[index] = new Zoom(el);
        }
        ...
        this.onUnload = function () {
            ...
            ProductVideo.removeSectionVideos(this.settings.sectionId);
            ProductModel.removeSectionModels(this.settings.sectionId);
