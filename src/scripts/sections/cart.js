...
const Cart = (function () {
    function Cart(container) {
        ...
        this.onLoad = function () {
            ...
            this._handleInputQty = Helpers.debounce(
        ...
        this._setLineItemImage = function (itemNode, featuredImage) {
            ...
            var sizedImageUrl =
                featuredImage.url !== null
                    ? getSizedImageUrl(featuredImage.url, 'x190')
                    : null;
        ...
        this._createItemPrice = function (original_price, final_price) {
            var originalPriceHTML = formatMoney(
                original_price,
                theme.moneyFormat
            );
        ...
        this._createUnitPrice = function (unitPrice, unitPriceMeasurement) {
            ...
            unitPriceGroup.querySelector(
                selectors.unitPrice
            ).innerHTML = formatMoney(unitPrice, theme.moneyFormat);
