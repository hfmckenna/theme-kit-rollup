import * as themeA11y from '@shopify/theme-a11y'
...
import * as themePredictiveSearch from '@shopify/theme-predictive-search'
import * as themePredictiveSearchComponent from '@shopify/theme-predictive-search-component'
import * as themeProduct from '@shopify/theme-product'
import * as themeProductForm from '@shopify/theme-product-form'
import * as themeSections from '@shopify/theme-sections'
...
slate.a11y = themeA11y;
theme.Images = themeImages;
theme.Currency = themeCurrency;
...
Shopify.theme.PredictiveSearch = themePredictiveSearch;
Shopify.theme.PredictiveSearchComponent = themePredictiveSearchComponent;
...
document.addEventListener('DOMContentLoaded', function () {
    themeSections.register('cart-template', new Cart);
    themeSections.register('product', new Product);
    themeSections.register('collection-template', new Filters);
    themeSections.register('product-template', new Product);
    themeSections.register('header-section', theme.HeaderSection);
    themeSections.register('map', theme.Maps);
    themeSections.register('slideshow-section', theme.SlideshowSection);
    themeSections.register('store-availability', theme.StoreAvailability);
    themeSections.register('video-section', theme.VideoSection);
    themeSections.register('quotes', theme.Quotes);
    themeSections.register('hero-section', theme.HeroSection);
    themeSections.register('product-recommendations', theme.ProductRecommendations);
    themeSections.register('footer-section', theme.FooterSection);
    themeSections.load(['cart','product','collection-template']);
